...
# Initialize a dictionary to store the sum of confidence levels and count for each genre
...
# Print the average confidence levels for each genre
for genre, avg_confidence in genre_confidence_averages.items():
    print(f"Average confidence level for {genre}: {avg_confidence}")

# Print the predicted genre
print(f"The predicted genre of the whole song is: {predicted_genre}")
